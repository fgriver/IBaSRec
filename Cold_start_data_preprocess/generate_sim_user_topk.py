...
Input:
  ../cold_start_dataset/{dataset_name}/{llm_model}_user_emb_matrix.pickle
Output:
  ../cold_start_dataset/{dataset_name}/sim_user_{topk}.pkl
...
def main():
    ...
    parser.add_argument("--dataset_dir", type=str, default="../cold_start_dataset",
                        help="Dataset root dir. If running inside data_preprocess, use ../cold_start_dataset")
