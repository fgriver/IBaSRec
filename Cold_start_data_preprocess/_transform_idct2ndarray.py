...
dataset:Beauty, Sports_and_Outdoors, Toys_and_Games

用法示例：
    python _transform_idct2ndarray.py \
        --input_path ../cold_start_dataset/Beauty/qwen3_emb.pickle \
        --output_path ../cold_start_dataset/Beauty/qwen3_emb_matrix.pickle
"""
...
def parse_args():
    ...
    parser.add_argument("--input_path", type=str, default='../cold_start_dataset/Sports_and_Outdoors/qwen3_emb.pickle',
                        help="Input pickle file (dict format).")
    parser.add_argument("--output_path", type=str, default='../cold_start_dataset/Sports_and_Outdoors/qwen3_emb_matrix.pickle',
